<template>
    <default-layout>
        <div class="flex justify-center place-content-center py-24 px-24">
            <div
            ...
            >
                ...
                <div class="p-6 flex flex-col justify-start w-80 md:w-full">
                    ...
                    <ul>
                        <li>
                            <p class="py-6 font-bold font-mono">Google</p>
                            <p class="py-6 font-bold font-mono">
                                <a
                                    class="text-blue-600 hover:text-blue-700 font-semibold underline box-decoration-slice"
                                    href="https://policies.google.com/technologies/ads"
                                    >Google Technologies Ads</a
                    ...
                    <h2 class="font-bold text-2xl font-serif mt-12">Consent</h2>
