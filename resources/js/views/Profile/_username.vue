<template>
    <div>
        ...
        >
            ...
            Halo, welcome back {{ user.name }} with
            {{ user.activation_id ? "activation id : " : "With Google ID : " }}
            {{ user.activation_id ? user.activation_id : googleId }} , login as
            {{ user.activation_id ? username : user.email }}
        </div>
    </div>
</template>
